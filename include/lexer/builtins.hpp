...
static const inline std::unordered_map<std::string_view, std::vector<std::string_view>> primitive_implicit_casting_table = {
    ...
    {"(i8, i8, i8)", {"i8x3"}},
    {"(i8, i8, i8, i8)", {"i8x4"}},
    {"(i8, i8, i8, i8, i8, i8, i8, i8)", {"i8x8"}},
    {"i8x2", {"(i8, i8)", "str"}},
    {"i8x3", {"(i8, i8, i8)", "str"}},
    {"i8x4", {"(i8, i8, i8, i8)", "str"}},
    {"i8x8", {"(i8, i8, i8, i8, i8, i8, i8, i8)", "str"}},
    {"(u16, u16)", {"u16x2"}},
    {"(u16, u16, u16)", {"u16x3"}},
    {"(u16, u16, u16, u16)", {"u16x4"}},
    {"(u16, u16, u16, u16, u16, u16, u16, u16)", {"u16x8"}},
    {"u16x2", {"(u16, u16)", "str"}},
    {"u16x3", {"(u16, u16, u16)", "str"}},
    {"u16x4", {"(u16, u16, u16, u16)", "str"}},
    {"u16x8", {"(u16, u16, u16, u16, u16, u16, u16, u16)", "str"}},
    {"(i16, i16)", {"i16x2"}},
    {"(i16, i16, i16)", {"i16x3"}},
    {"(i16, i16, i16, i16)", {"i16x4"}},
    {"(i16, i16, i16, i16, i16, i16, i16, i16)", {"i16x8"}},
    {"i16x2", {"(i16, i16)", "str"}},
    {"i16x3", {"(i16, i16, i16)", "str"}},
    {"i16x4", {"(i16, i16, i16, i16)", "str"}},
    {"i16x8", {"(i16, i16, i16, i16, i16, i16, i16, i16)", "str"}},
    {"(u32, u32)", {"u32x2"}},
    {"(u32, u32, u32)", {"u32x3"}},
    {"(u32, u32, u32, u32)", {"u32x4"}},
    {"(u32, u32, u32, u32, u32, u32, u32, u32)", {"u32x8"}},
    {"u32x2", {"(u32, u32)", "str"}},
    {"u32x3", {"(u32, u32, u32)", "str"}},
    {"u32x4", {"(u32, u32, u32, u32)", "str"}},
    {"u32x8", {"(u32, u32, u32, u32, u32, u32, u32, u32)", "str"}},
    {"(i32, i32)", {"i32x2"}},
    {"(i32, i32, i32)", {"i32x3"}},
