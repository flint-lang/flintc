#ifndef __ERR_STMT_RETURN_CREATION_FAILED_HPP__
#define __ERR_STMT_RETURN_CREATION_FAILED_HPP__
...
class ErrStmtReturnCreationFailed : public BaseError {
  public:
    ErrStmtReturnCreationFailed(const ErrorType error_type, const std::string &file, const token_list &tokens) :
