...
class ErrDefEntityDuplicateParentAccessor : public BaseError {
  public:
    ...
    std::string to_string() const override {
        ...
        oss << BaseError::to_string() << "└─ Entity defines the same parent accessor '" << YELLOW << parent_accessor << DEFAULT
            << "' twice";
        return oss.str();
    }
    ...
    Diagnostic to_diagnostic() const override {
        ...
        d.message = "Entity defines the same parent accessor '" + parent_accessor + "' twice";
        return d;
    }
