...
class ErrDefEntityDuplicateAccessorInConstructor : public BaseError {
  public:
    ...
    std::string to_string() const override {
        ...
        oss << BaseError::to_string() << "└─ Entity constructor contains accessor '" << YELLOW << accessor << DEFAULT << "' twice";
        return oss.str();
    }
    ...
    Diagnostic to_diagnostic() const override {
        ...
        d.message = "Entity constructor contains accessor '" + accessor + "' twice";
        return d;
    }
