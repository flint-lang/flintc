...
/// link
///     Goes through all the imports in the file and scans all the imported files, and links them again, and so on. Replaces all the 'use "..."' tokens inside the tokens list with the content of the imported file recursively
...
/// check_for_imports
///     Goes through a given list of tokens and returns all the paths of included files inside this token list, if there are any inclusions at all. When no inclusion ('use') is present, None is returned.
...
/// link_next_use
///     Goes to the line of the import, removes the import (the provided use) from the token list and inserts all the scanned tokens of the file to insert into the token list
